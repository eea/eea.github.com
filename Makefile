...
clean:
	-rm -rf $(BUILDDIR)/_images
	-rm -rf $(BUILDDIR)/_sources
	-rm -rf $(BUILDDIR)/_static
	-rm -f $(BUILDDIR)/genindex.html
	-rm -f $(BUILDDIR)/index.html
	-rm -f $(BUILDDIR)/objects.inv
	-rm -f $(BUILDDIR)/search.html
	-rm -f $(BUILDDIR)/searchindex.js
...
warnings-html:
	$(SPHINXBUILD) -W -ab html $(ALLSPHINXOPTS) $(BUILDDIR)
	@echo
	@echo "Build finished. The HTML pages are in $(BUILDDIR)."
...
htmlhelp:
	$(SPHINXBUILD) -ab htmlhelp $(ALLSPHINXOPTS) $(BUILDDIR)/htmlhelp
	@echo
